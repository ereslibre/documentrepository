...
{
	var from_position = $($('#js_from').text() + ': <input type="text" id="Character_from_position' + positioni + '" name="Character[from_position' + positioni + ']" />');
	var to_position = $($('#js_to').text() + ': <input type="text" id="Character_to_position' + positioni + '" name="Character[to_position' + positioni + ']" />');
	var position = $('<input type="hidden" id="Character_position' + positioni + '" name="Character[position' + positioni + ']" />');
	var position_label = ' ' + $('#js_position').text() + ': ' + position_name_;
    ...
    wrapper.append($('#js_from').text() + ': ');
	wrapper.append(from_position);
    wrapper.append('&nbsp;' + $('#js_to').text() + ': ');
